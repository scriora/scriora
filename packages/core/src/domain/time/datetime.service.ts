  ...
  public getSmartScheduleSlots(options?: SmartScheduleOptions): SmartScheduleSlot[] {
    ...
    const youtubeSlotTemplates = [
      ...
      },
      {
        ...
        score: 95,
        reason:
          'الأحد 9:00 ص: ذروة التصفح والمشاهدة الصباحية في عطلة نهاية الأسبوع (معامل تفاعل 0.80)',
      },
      {
        dayOfWeek: 5, // Friday
        hour: 16,
      ...
      },
      {
        ...
        score: 92,
        reason:
          'الجمعة 12:00 م: ذروة استراحة الغداء وتفاعل قوي لفيديوهات يوتيوب (معامل تفاعل 0.70)',
      },
      {
        dayOfWeek: 5, // Friday
        hour: 18,
        ...
        score: 91,
        reason:
          'الجمعة 6:00 م: توقيت مسائي قوي لـ YouTube Shorts ومشاهدات الاسترخاء بعد أسبوع العمل',
      },
      {
        dayOfWeek: 2, // Tuesday
        hour: 9,
        ...
        score: 88,
        reason:
          'الثلاثاء 9:00 ص: أفضل أوقات أيام العمل الصباحية للفيديوهات التعليمية والتقنية على يوتيوب',
      },
      {
        dayOfWeek: 1, // Monday
        hour: 9,
